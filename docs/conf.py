...
htmlhelp_basename = 'invenio-classifier_namedoc'
...
latex_documents = [
  (master_doc, 'invenio-classifier.tex', u'invenio-classifier Documentation',
   u'CERN', 'manual'),
]
...
man_pages = [
    (master_doc, 'invenio-classifier', u'invenio-classifier Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'invenio-classifier', u'Invenio-Classifier Documentation',
   author, 'invenio-classifier', 'Invenio module for record classification.',
   'Miscellaneous'),
]
