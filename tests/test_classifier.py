...
def test_file_extration(app, demo_pdf_file, demo_taxonomy):
    ...
    with app.app_context():
        ...
        assert {
            "keyword": "gauge field theory Yang-Mills",
            "number": 9,
        } in single_keywords
...
def test_author_keywords(app, demo_pdf_file_with_author_keywords, demo_taxonomy):
...
def test_funny_author_keywords(
    app, demo_pdf_file_with_funny_author_kw_sep, demo_taxonomy
):
